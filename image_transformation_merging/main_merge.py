...
morphed = merge.morph(im1, im2, points1, points2, triangles, 0.3, 0.7)
skio.imshow(morphed)
skio.show()
#skio.imsave("./video/out/"+sys.argv[1]+".jpg", morphed)
...
#    skio.imsave("./timelapse/morph/" + str(imname) + str(i).zfill(3) + ".jpg", morphed)
#    i += 1
